    ...
    public IHealthMetadata checkHealth() {
        return new IHealthMetadata() {
            ...
            public String getHost() {
                return getProperty("db.mysql.host");
            }
            ...
            public String getUrl() {
                try {
                    ...
                    sb.append(createHostReplacedUrl()).append("\n");
             ...
             * @return url
             */
            private String createHostReplacedUrl() throws MalformedURLException, UnknownHostException {
                String mysqlUrl = getProperty("db.mysql.url");
                return "localhost".equals(getHost()) ? mysqlUrl.replace(getHost(), InetAddress.getLocalHost().getHostName()) :
                        mysqlUrl;
            }
