(function () {
    ...
    function crudService($http, $q) {
        ...
        function configure() {
            return $http.get(config.component.path + 'crud6.json').then(response => {
    ...
    function myService($http) {
        ...
        function configure() {
            ...
            return $http.get(config.context + 'api/cqproviders/').then(response => {
                var data = response.data;
                return data;
            });
        }
    ...
    ngApp.component('crud', {
        templateUrl: config.component.path + 'crud6.html',
        controller: crudCtrl,
        controllerAs: 'vm',
        bindings: {}
    });
