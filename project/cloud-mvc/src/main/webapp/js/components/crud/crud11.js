(function () {
    ...
    function crudService($http, $q) {
        ...
        function configure() {
            return $http.get(config.component.path + 'crud11.json').then(response => {
    ...
    function myService($http) {
        ...
        function configure() {
            ...
            return $http.get(config.context + 'api/cdproviders/').then(response => {
                var data = response.data;
                return data;
            });
        }
    ...
    ngApp.component('crud', {
        templateUrl: config.component.path + 'crud11.html',
        controller: crudCtrl,
        controllerAs: 'vm',
        bindings: {}
    });
